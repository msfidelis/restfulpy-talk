...
from comentarios.serializers import ComentarioSerializer, PostSerializer
...
##
# Exemplo de uma resposta em JSON sem um serializer_class
# Pra você retornar o que vc quiser, sem preciosar de um Model :)
##
class RespostasEmJson(generics.GenericAPIView):

    ##
    # Retorna um JSON dinamico
    ##      
    def get(self, request, *args, **kwargs):
        return JsonResponse({"teste":"isto é um json"})
